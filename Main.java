...
class Test{
    public static void main(String[] args) {
        ...
        System.out.println();
        switch (choice) {
            case 1://Login logic for Customer
                System.out.println("Logging in as Customer...");
                obj.speciality_tours(); //func call
                obj.itinerary_details();
                obj.short_details_each_package();
                obj.search_or_sort();
                obj.calc_price();
                obj.Date();
                obj.user_details();
...
class MiniProject {// declare all linkedhsahmapsspeciality tours
    static LinkedHashMap<String, String> specialtyTours = new LinkedHashMap<>();
    static LinkedHashMap<String, LinkedHashMap<String, String>> tourDetails = new LinkedHashMap<>();// tourDetails parent lhm
    static LinkedHashMap<String, String> tourInfo2100 = new LinkedHashMap<>(); // for each package one lhm
    ...
    static LinkedHashMap<String, Integer> tourPrices = new LinkedHashMap<>();    //price lhm
    static LinkedHashMap<String, String> itineraryDetails = new LinkedHashMap<>();//itinerary lhm
    static String name;
    ...
    {// Adding specialty tours to the LinkedHashMap
        ...
        for (Map.Entry<String, String> entry : specialtyTours.entrySet()) { // Iterating through the LinkedHashMap using a for-each loop
    ...
    public static void login_as_admin() {
        ...
        int ch=sc.nextInt();
        switch(ch) {
            case 1: System.out.println("Enter the name of the package you want to add:");
                String name = sc.next();
                sc.nextLine();
                ...
                break;
            case 2: System.out.println("Enter the name of package you want to remove from :\nChota Break\nYouth Special: Adventure"
                        + "\nSpritual tours\nHoneymoon Special");
...
//USE OF WHILE LOOP TILL THE USER ENTERS VALID EMAIL
    ...
    public static void disp_bill(){
        ...
        System.out.println();
        System.out.println("Displaying details of the tour chosen :"); //printing details of specific id
        System.out.println();
        System.out.println("Itinerary for Package " + tourId + ":");
        for (Map.Entry<String, String> entry : itineraryDetails.entrySet()) {
           String itinerary = itineraryDetails.get(tourId);
    ...
    public static void Date() {
        Scanner scanner = new Scanner(System.in);
        LocalDateTime currentDate= LocalDateTime.now();  //printing current date & time
        ...
        System.out.println();
        System.out.println("Enter the start date of the tour (YYYY-MM-DD):"); // Input start date of the tour
        String sd = scanner.nextLine();
        LocalDate startDate = parseDate(sd);  // Parse the start date
        System.out.println("Enter the number of tour days:");   // Input number of tour days
        int tourDays = scanner.nextInt();
        LocalDate endDate = startDate.plusDays(tourDays);    // Calculate end date based on the number of tour days
